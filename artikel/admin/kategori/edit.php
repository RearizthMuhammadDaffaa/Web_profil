...
$result = mysqli_query($mysqli, "SELECT * FROM tb_kategori WHERE id=$id");
...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE tb_kategori SET nama_kategori='$nama_kategori' WHERE id=$id");
    // update user data
